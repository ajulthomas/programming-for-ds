...
# slices the array x to obtain elements at index 1 and 2
y = x[1:3]

# obtain element at index 3
z = x[3:4]

# list containing the fifth and zeroth elemnet 
t = x[4::-4]

# get first two elements from third element
u = x[3][0:2]
