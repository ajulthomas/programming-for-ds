...
def read_ellipse_file(filename):
    ...
    try:
        ...
        while True:
            ...
            line = line.replace('\n', '')
            xystring = line.split(' ')
            # appending data into the list should be inside the while loop
            # otherwise it will only append one pair of value to the list, 
            # which was the error in the code provided in the question
